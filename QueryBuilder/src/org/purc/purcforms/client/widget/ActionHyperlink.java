 ...
 *
 */
public class ActionHyperlink extends AddConditionHyperlink {
	...
	public ActionHyperlink(String text, String targetHistoryToken,boolean allowDelete, int depth,AddConditionHyperlink addConditionHyperlink,FilterRowActionListener actionListener){
